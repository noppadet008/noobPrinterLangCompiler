...
{
       0,     0,     3,     4,     7,    13,    19,    23,    27,    31,
      36,    39,    41,    44,    46,    48,    52,    56,    60,    64,
      68,    72,    76,    80,    84
};
...
{
      27,     0,    -1,    -1,    28,    27,    -1,     6,    30,    10,
      27,    11,    -1,     7,    30,    10,    27,    11,    -1,     8,
      29,    15,    -1,     8,    14,    15,    -1,     9,    29,    15,
      -1,     5,    16,    29,    15,    -1,     5,    15,    -1,     3,
      -1,    20,     3,    -1,     4,    -1,     5,    -1,    29,    21,
      29,    -1,    29,    20,    29,    -1,    29,    24,    29,    -1,
      29,    23,    29,    -1,    29,    22,    29,    -1,    12,    29,
      13,    -1,    29,    17,    29,    -1,    29,    19,    29,    -1,
      29,    18,    29,    -1,    29,    -1
};
...
{
       0,    43,    43,    45,    64,    71,    77,    82,    89,    94,
      99,   106,   110,   114,   118,   122,   134,   146,   158,   170,
     182,   188,   194,   200,   206
};
#endif
...
{
  "$end", "error", "$undefined", "NUM", "HEX", "IDEN", "WHEN", "LOOP",
  "PRINT", "PRINT16", "OB", "CB", "LP", "RP", "STRING", "SEMICOLON",
  "ASSIGN", "EQ", "LESSTHAN", "MORETHAN", "MINUS", "ADD", "MOD", "DIV",
  "MUL", "NEG", "$accept", "block", "statement", "expression", "condition", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
      ...
      11,    13,    14,     0,     0,    24,     0,     0,     0,     0,
       0,     1,     3,     0,     0,    12,     0,     0,     0,     0,
       0,     0,     0,     0,     2,     2,     7,     6,     8,     9,
      20,    21,    23,    22,    16,    15,    19,    18,    17,     0,
       0,     4,     5
};
...
{
      10,     5,    33,    33,    30,    33,     2,    10,   -17,    33,
     -17,   -17,   -17,    33,    27,    62,    29,    31,    25,    34,
      44,   -17,   -17,    54,   -10,   -17,    33,    33,    33,    33,
      33,    33,    33,    33,    10,    10,   -17,   -17,   -17,   -17,
     -17,    67,    67,    67,   -16,   -16,   -17,   -17,   -17,    32,
      35,   -17,   -17
};
...
{
      19,    20,    21,    40,    22,    23,    31,    32,    33,    24,
      29,    30,    31,    32,    33,     1,     2,     3,     4,     5,
       8,     9,    41,    42,    43,    44,    45,    46,    47,    48,
      25,    49,    50,    10,    11,    12,    10,    11,    12,    34,
      36,    35,    13,    51,    18,    13,    52,     0,    17,    37,
      14,     0,     0,    14,    29,    30,    31,    32,    33,    38,
       0,     0,     0,     0,    29,    30,    31,    32,    33,    39,
       0,     0,     0,     0,    29,    30,    31,    32,    33,    26,
...
{
       4,     5,     0,    13,     7,     9,    22,    23,    24,    13,
      20,    21,    22,    23,    24,     5,     6,     7,     8,     9,
      15,    16,    26,    27,    28,    29,    30,    31,    32,    33,
       3,    34,    35,     3,     4,     5,     3,     4,     5,    10,
      15,    10,    12,    11,    14,    12,    11,    -1,     3,    15,
      20,    -1,    -1,    20,    20,    21,    22,    23,    24,    15,
      -1,    -1,    -1,    -1,    20,    21,    22,    23,    24,    15,
      -1,    -1,    -1,    -1,    20,    21,    22,    23,    24,    17,
...
{
       0,     5,     6,     7,     8,     9,    27,    28,    15,    16,
       3,     4,     5,    12,    20,    29,    30,    30,    14,    29,
      29,     0,    27,    29,    29,     3,    17,    18,    19,    20,
      21,    22,    23,    24,    10,    10,    15,    15,    15,    15,
      13,    29,    29,    29,    29,    29,    29,    29,    29,    27,
      27,    11,    11
};
...
#line 83 "comp.y"
    {
				Syntax* printstmt =  print_new(countstr,(yyvsp[(2) - (3)].str));
...
#line 95 "comp.y"
    {
				Syntax *exp = stack_pop(syntax_stack);
				stack_push(syntax_stack,assignment_new((yyvsp[(1) - (4)].str), exp));
			;}
    break;
...
#line 100 "comp.y"
    {
				stack_push(syntax_stack,variable_new((yyvsp[(1) - (2)].str)));
			;}
    break;
...
#line 107 "comp.y"
    {
					stack_push(syntax_stack, immediate_new((yyvsp[(1) - (1)].num)));
				;}
    break;
...
#line 111 "comp.y"
    {
					stack_push(syntax_stack, immediate_new((yyvsp[(2) - (2)].num)*(-1)));
				;}
    break;
...
#line 119 "comp.y"
    {
					stack_push(syntax_stack,variable_new((yyvsp[(1) - (1)].str)));
				;}
    break;
